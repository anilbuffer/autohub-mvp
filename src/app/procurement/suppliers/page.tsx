    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-slate-500 font-medium">Global Supplier Network</span>
          </div>
          <h1 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2">
            <Building2 className="w-6 h-6 text-[#ed2025]" />
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#ed2025] hover:bg-[#d3181d] text-white font-bold text-xs shadow-xs transition"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {filteredSuppliers.map((s) => (
          <div
            key={s.id}
            className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-xs hover:border-slate-300 transition space-y-3.5 flex flex-col justify-between"
          >
              ...
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <div className="text-[11px] text-slate-500 flex items-center gap-1.5 mt-1 font-medium">
                    <Globe className="w-3 h-3 text-[#ed2025]" />
                    <span>{s.country}</span>
                    <span>•</span>
